...
#+RESULTS:
#+begin_export html
<script src="north_frigid_zone.js" id="18b6baf0-fb8a-4fc6-9586-2606a125df8c"></script>
#+end_export
...
#+RESULTS:
#+begin_export html
<script src="all_zones.js" id="e88941ad-68d5-4e10-bfa3-1e1a6549121f"></script>
#+end_export
...
#+RESULTS:
#+begin_export html
<script src="hemispheres.js" id="8aece51a-e3b0-45de-bac3-75dfb19bf4fc"></script>
#+end_export
...
#+RESULTS:
#+begin_export html
<script src="tropics.js" id="6540b168-d7f2-48f9-9007-4ab5849b26c5"></script>
#+end_export
...
#+RESULTS:
#+begin_export html
<script src="zones.js" id="c352d410-47b4-4420-be79-3cbd0f63bae8"></script>
#+end_export
