...
imputed_X_valid = pandas.DataFrame(imputer.fit_transform(x_validate))
#+end_src
...
final_x_train = pandas.DataFrame(imputer.fit_transform(x_train),
                                 columns=x_train.columns)
final_x_validate = pandas.DataFrame(imputer.fit_transform(x_validate),
...
final_x_train_2 = pandas.DataFrame(imputer_2.fit_transform(x_train),
                                   columns=x_train.columns)
final_x_validate_2 = pandas.DataFrame(imputer_2.fit_transform(x_validate),
                                      columns=x_validate.columns)
#+end_src
