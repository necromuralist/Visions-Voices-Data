...
** Imports
*** Python
#+begin_src jupyter-python :session importance :results none
...
#+begin_src jupyter-python :session importance :results output raw :exports both
...
| False   |      64 |         50.00 |
** The Features
#+begin_src jupyter-python :session importance :results output :exports both
print(data.info())
#+end_src
